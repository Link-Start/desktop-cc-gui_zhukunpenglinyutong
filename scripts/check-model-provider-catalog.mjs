...
for (const engine of ["codex", "gemini", "kimi"]) {
...
console.log(
  `model provider catalog valid: codex=${artifact.engines.codex.length}, gemini=${artifact.engines.gemini.length}, kimi=${artifact.engines.kimi.length}`,
);
