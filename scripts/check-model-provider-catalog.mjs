...
for (const engine of ["codex", "gemini", "grok", "kimi"]) {
...
console.log(
  `model provider catalog valid: codex=${artifact.engines.codex.length}, gemini=${artifact.engines.gemini.length}, grok=${artifact.engines.grok.length}, kimi=${artifact.engines.kimi.length}`,
);
