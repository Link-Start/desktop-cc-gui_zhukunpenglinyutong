# codex-provider-management Specification

## Purpose

Defines Codex managed provider presets and management surfaces available to users, including third-party provider presets such as Atlas Cloud.
