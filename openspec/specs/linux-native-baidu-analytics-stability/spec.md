# linux-native-baidu-analytics-stability Specification

## Purpose

Defines Linux-native Baidu analytics transport that bypasses unsafe WebKit network paths while preserving PV/UV delivery and visitor identity.
