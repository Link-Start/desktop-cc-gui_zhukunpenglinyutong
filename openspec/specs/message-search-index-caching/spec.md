# message-search-index-caching Specification

## Purpose

Define snapshot-scoped message indexing so repeated search queries avoid rebuilding unchanged conversation data while preserving existing matching behavior.
