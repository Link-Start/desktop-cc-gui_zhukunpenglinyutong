...
| [`fix-shared-context-resume-integrity`](fix-shared-context-resume-integrity/proposal.md) | artifacts ready / await apply | 失败后续接空 package 只发「继续」丢原任务；empty-handoff guard + rematerialize；**artifacts 齐，待审后实现** | [proposal](fix-shared-context-resume-integrity/proposal.md) · [design](fix-shared-context-resume-integrity/design.md) · [tasks](fix-shared-context-resume-integrity/tasks.md) · [specs](fix-shared-context-resume-integrity/specs/) |
