...
const mockTranslate = (key: string, params?: Record<string, unknown>) => {
      ...
      const translations: Record<string, string> = {
        ...
        "settings.piIssueDetected": "PI CLI issue detected",
        ...
        "settings.workspaceWallpaper": "Page background",
        "settings.workspaceWallpaperDesc":
          "Background after you enter the app. Off by default.",
        "settings.workspaceWallpaperFluid": "Fluid",
        "settings.workspaceWallpaperNone": "None",
        "settings.workspaceWallpaperCustom": "Custom",
        "settings.workspaceWallpaperChoose": "Choose image",
        "settings.workspaceWallpaperClear": "Clear image",
        "settings.workspaceWallpaperMissing":
          "No image selected yet. The default backdrop is used for now.",
        "settings.workspaceWallpaperPreset": "Background palette",
        "settings.workspaceWallpaperPreset_mist": "Mist",
        "settings.workspaceWallpaperPreset_aurora": "Aurora",
        "settings.workspaceWallpaperPreset_dusk": "Dusk",
        "settings.workspaceWallpaperPreset_orchid": "Orchid",
        "settings.workspaceWallpaperPreset_ember": "Ember",
        "settings.workspaceWallpaperPreset_ink": "Ink",
        "settings.workspaceWallpaperPreset_ash": "Ash",
        "settings.workspaceWallpaperMotion": "Fluid motion",
        "settings.workspaceWallpaperMotion_drift": "Drift",
        "settings.workspaceWallpaperMotion_taiji": "Tai Chi",
        "settings.workspaceWallpaperMotion_storm": "Storm",
        "settings.workspaceWallpaperMotion_tornado": "Tornado",
        "settings.workspaceWallpaperMotion_chase": "Chase",
        "settings.workspaceWallpaperVeil": "Frosted glass",
        "settings.workspaceWallpaperVeilValue": "{{value}}px",
        ...
        "statusPanel.emptyTodos": "No tasks",
        "statusPanel.todoProgressDone": "{{done}} completed",
        "statusPanel.todoProgressActive": "{{active}} in progress",
        "statusPanel.todoProgressPending": "{{pending}} pending",
        ...
        "messages.middleStepsCollapsedHint": "{{count}} 步",
        "messages.middleStepsProcessed": "",
        "messages.middleStepsProcessedWithDuration": "{{duration}}",
