 ...
 * - 默认折叠，避免打断设置列表的清爽节奏；需要时再展开。
 * - 复用 messages/file-tree/diff-viewer 的 selector 上下文。
 */
...
export function SyntaxAndDiffPreview({
  appearance,
  defaultExpanded = false,
}: SyntaxAndDiffPreviewProps) {
  const { t } = useTranslation();
  const [expanded, setExpanded] = useState(defaultExpanded);

  return (
    <div
      className={`settings-pref-row settings-pref-row--stack settings-theme-preview-item${
        expanded ? " is-expanded" : ""
      }`}
    >
      <button
        type="button"
        className="settings-pref-preview-toggle"
      ...
      >
        ...
        <span className="settings-pref-preview-chevron" aria-hidden>
      ...
      {expanded ? (
        ...
        >
          <div className="theme-preview-grid__code-col">
            <div className="theme-preview-grid__panel">
              <div className="theme-preview-grid__panel-header">
                {t("settings.themePreviewCodePanel", {
                  defaultValue: "代码块 (Markdown)",
                })}
              </div>
            ...
            <div className="theme-preview-grid__panel">
              <div className="theme-preview-grid__panel-header">
                {t("settings.themePreviewFilePanel", {
                  defaultValue: "文件预览 (file-view)",
                })}
              </div>
          ...
          <div className="theme-preview-grid__diff-col">
            <div className="theme-preview-grid__panel">
              <div className="theme-preview-grid__panel-header">
                {t("settings.themePreviewDiffPanel", {
                  defaultValue: "Diff 行级",
                })}
              </div>
              ...
              <div className="theme-preview-grid__legend">
                <span className="theme-preview-legend theme-preview-legend--add">
                  ...
                  {t("settings.themePreviewLegendAdd", {
                    defaultValue: "新增",
                  })}
                ...
                <span className="theme-preview-legend theme-preview-legend--del">
                  <span className="theme-preview-legend__dot" />
                  {t("settings.themePreviewLegendDel", {
                    defaultValue: "删除",
                  })}
                  <code>text · bg · gutter</code>
                </span>
