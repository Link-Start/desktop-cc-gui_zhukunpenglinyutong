...
const intentCanvas = {
  intentCanvas: {
    ...
    manager: {
      ...
      countSubtitle: "{{count}} canvases · by update time",
      eraWeek: "This week",
      eraStale: "Earlier",
      eraAggregate: "{{count}} · {{elements}} elements",
      eraStaleAggregate: "{{count}} · idle {{days}} days",
      eraCleanupHint: "Suggested cleanup",
      selectEra: "Select this group",
      staleAnchorsBroken: "Broken anchors",
      staleEmpty: "Empty canvas",
      staleInactive: "Idle {{days}} days",
