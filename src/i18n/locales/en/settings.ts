  ...
  settings: {
    ...
    vendor: {
      ...
      ccSwitchImport: {
        ...
        subtitle: "Select configurations to import into the third-party provider list",
        categoryAnthropic: "Anthropic",
        categoryOpenAI: "OpenAI",
        configCount: "{{count}} configs",
        selectedCount: "Selected {{selected}} / {{total}} importable",
        ...
        loading: "Reading CC Switch config…",
        ...
        close: "Close",
        importing: "Importing…",
        importButton: "Import {{count}} providers",
      },
      add: "Add",
      edit: "Edit",
      delete: "Delete",
