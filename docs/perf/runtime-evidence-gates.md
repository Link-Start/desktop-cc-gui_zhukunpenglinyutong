...
| docs/perf/realtime-runtime-evidence.json | S-RS-FT | firstDeltaLatencyP95 | 3146 | ms | measured |  |  | measured runtime turn trace sendToFirstDeltaMs from .artifacts/realtime-runtime-diagnostics.json | Correlate replay metrics with runtime visible-lag and terminal-pressure traces. |
| docs/perf/realtime-runtime-evidence.json | S-RS-TA | turnStartAckLatencyP95 | unsupported | ms | unsupported |  |  | No stream-latency/codex-turn-start-ack diagnostics were found. Run a build with Codex turn-start ack instrumentation. | Correlate replay metrics with runtime visible-lag and terminal-pressure traces. |
| docs/perf/realtime-runtime-evidence.json | S-RS-PA | codexPostAckFirstDeltaP95 | 2371 | ms | measured |  |  | measured renderer stream-latency/app-server-event Codex ccguiTiming from .artifacts/realtime-runtime-diagnostics.json | Correlate replay metrics with runtime visible-lag and terminal-pressure traces. |
| docs/perf/realtime-runtime-evidence.json | S-RS-PR | codexPostAckFirstRuntimeEventP95 | 1 | ms | measured |  |  | measured renderer stream-latency/app-server-event Codex first runtime event from .artifacts/realtime-runtime-diagnostics.json | Correlate replay metrics with runtime visible-lag and terminal-pressure traces. |
| docs/perf/realtime-runtime-evidence.json | S-RS-RT | codexFirstRuntimeEventToFirstTextDeltaP95 | 2370 | ms | measured |  |  | measured renderer stream-latency/app-server-event Codex runtime-event-to-text phase from .artifacts/realtime-runtime-diagnostics.json | Correlate replay metrics with runtime visible-lag and terminal-pressure traces. |
| docs/perf/realtime-runtime-evidence.json | S-RS-RI | codexFirstRuntimeEventToFirstAssistantItemP95 | 2365 | ms | measured |  |  | measured renderer stream-latency/app-server-event Codex runtime-event-to-assistant-item phase from .artifacts/realtime-runtime-diagnostics.json | Correlate replay metrics with runtime visible-lag and terminal-pressure traces. |
| docs/perf/realtime-runtime-evidence.json | S-RS-IT | codexFirstAssistantItemToFirstTextDeltaP95 | 5 | ms | measured |  |  | measured renderer stream-latency/app-server-event Codex assistant-item-to-text phase from .artifacts/realtime-runtime-diagnostics.json | Correlate replay metrics with runtime visible-lag and terminal-pressure traces. |
| docs/perf/realtime-runtime-evidence.json | S-RS-VL | visibleTextLagP95 | 145 | ms | measured | 2000 | 5000 | measured runtime turn trace from .artifacts/realtime-runtime-diagnostics.json | Correlate replay metrics with runtime visible-lag and terminal-pressure traces. |
...
| docs/perf/realtime-runtime-evidence.json | S-RS-TS | terminalSettlementP95 | 20 | ms | measured | 100 | 250 | measured runtime turn trace from .artifacts/realtime-runtime-diagnostics.json | Correlate replay metrics with runtime visible-lag and terminal-pressure traces. |
