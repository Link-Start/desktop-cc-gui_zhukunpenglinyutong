...
> **Audience**: 后续参与设置页、偏好面板、表单型管理界面的工程师与 AI agent。  
> **Status**: Active product design baseline（2026-08 会话管理 / 基础设置改版沉淀）。  
> **Scope**: 设置壳（Settings）内「偏好列表型」界面；对话主界面、Composer 不在本指南主范围。  
> **Conflict rule**: 当前代码与本指南冲突时，以当前代码为准，并回写更新本指南。
...
| 外观 | `.../sections/BasicAppearanceSection.tsx` |
| 行为 | `.../sections/BasicBehaviorSection.tsx` |
| 打开方式 | `.../sections/OpenAppsSection.tsx` |
| Web 服务 | `.../sections/WebServiceSettings.tsx` |
| 邮件 | `.../sections/EmailSenderSettings.tsx` |
| 会话管理 | `.../sections/SessionManagementSection.tsx` |
...
```text
改造本项目设置/偏好 UI 时，遵循 docs/ui-ux/preference-settings-ui-guide.md：
