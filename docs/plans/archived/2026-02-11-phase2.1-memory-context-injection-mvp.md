...
> [!WARNING]
> **Lifecycle: Superseded historical plan.** 本文的 silent/default-auto injection 设计已被 explicit Memory Reference、default `off` contract 替代。历史 checkbox 不构成 backlog；current source：[Project Memory consumption spec](../../../openspec/specs/project-memory-consumption/spec.md)。
