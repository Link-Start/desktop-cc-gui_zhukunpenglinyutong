...
`shouldHideCodexCanvasCommandCard`：**恒 false**（2026-08-01：过程折叠控噪，command/bash 回幕布；API 名保留）。
...
| bash / shell / run_terminal_* / commandExecution | **显示**（过程折叠控噪） | BashToolBlock / bashGroup；Status Panel 仍可有活动态 |
